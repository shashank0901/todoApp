...
export default function Home() {
  // whatever input user writes in the input box, gets saved to this or stored in the hook
  const [todoInput, setTodoInput] = useState("");

  // and this todos array, whatever data user inputs, is added to this array. and displayed below in the todos list
      ...
      <div className="max-w-3xl mx-auto mt-10 p-8">
        <div className="bg-white -m-6 p-3 sticky top-0">
          <div className="flex justify-center flex-col items-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold">To Doo's</h1>
          </div>
        ...
        <div className="my-10">
          {todos.length > 0 &&
            todos.map((todo) => (
              <div
                key={todo.id}
                className="flex items-center justify-between mt-4 font-semibold placeholder:text-gray-500 border-[2px] border-black h-[60px] grow shadow-sm rounded-md px-4 focus-visible:outline-yellow-400 text-lg transition-all duration-300"
              >
